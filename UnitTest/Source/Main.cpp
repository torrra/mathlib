...
* Radian, Degree, Vector3 are by no means fully complete (you can add to them any function you think would be useful (ex: Vector3::angleFrom_fast(Vector3) that assume both vector are unit vector))
